...
export default function HistoryPage() {
  ...
  useEffect(() => {
    ...
    let socket: any;
    if (token) {
      socket = io(process.env.NEXT_PUBLIC_API_URL?.replace('/api/v1', '') || process.env.NEXT_PUBLIC_API_URL ? process.env.NEXT_PUBLIC_API_URL.replace('/api/v1', '') : 'https://teashopphela.onrender.com');
